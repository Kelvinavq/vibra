...
<html lang="es">
  ...
  <body>
    ...
    <section>
      ...
      <nav>
        ...
        <ul>
          ...
          <li class="active li"><a href="#inicio">Inicio</a></li>
          <li class="li"><a href="#ventajas">Ventajas</a></li>
          <li class="li"><a href="#procesos">Proceso</a></li>
          <li class="li"><a href="#portafolio">Portafolio</a></li>
      ...
      <div class="left">
        <div class="textos">
          ...
          <h2 class="animate__animated animate__backInUp">
            Construimos sitios web que trabajan por vos
          </h2>
          ...
          <p class="animate__animated animate__lightSpeedInRight">
            ...
            cliente, y con un mensaje claro, incrementan sus ventas mas de un
            25%.
          </p>
        </div>
    ...
    <section class="cards">
      ...
      <div class="Card animate__animated animate__backInUp">
        ...
        <div class="texto">
          ...
          <p>Tu sitio web optimizado y con código limpio</p>
        </div>
      </div>
    </section>
    ...
    <section id="ventajas" class="ventajas">
      <div class="titulo">
        <h2>
          ¿Sabías las ventajas de contar con un
          <strong>sitio web bien diseñado?</strong>
        </h2>
        <p>
          Nosotros nos encargamos de que tu negocio gane prestigio digital para
          que puedas icrementar tus ventas
        </p>
      </div>
      ...
      <div class="contenedor-ventajas">
        ...
        <div class="ventaja">
          ...
          <div class="texto">
            <p>Ganas prestigio y posicionamiento en el amplio mundo digital</p>
          </div>
        </div>
        ...
        <div class="ventaja">
          ...
          <div class="texto">
            <p>Facilita la parte organizacional y técnica de tu negocio</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="procesos" class="procesos">
      ...
      <div class="contenedor-proceso">
        ...
        <div class="proceso">
          ...
          <div class="contenido">
            ...
            <p>
              Podrás ver como construimos tu sitio web optimizado para convertir
              clientes.
            </p>
          </div>
        </div>
        ...
        <div class="proceso">
          ...
          <div class="contenido">
            ...
            <p>
              Tu herramienta de generación de clientes 24/7 comienza a
              funcionar.
            </p>
          </div>
        </div>
      ...
      <div class="texto">
        <p>
          Si querés descubrir cómo podemos diferenciarte del resto
          construyendote un sitio de alta performance que genere clientes 24/7,
          contactáte con nosotros para empezar.
        </p>
      </div>

      <button class="btn" onclick="window.location= '#contacto'">¡Quiero Presupuestos!</button>
    </section>

    <!-- metodo de desarrollo -->
    <section class="metodos">
      <div class="titulo">
        <h2 class="">¿Cómo trabajamos?</h2>
      </div>
    ...
    <section id="contacto" class="contacto">
      ...
      <form action="mail.php" id="contacto-form" method="post" >
        <div class="left">
